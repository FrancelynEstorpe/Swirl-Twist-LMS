...
Route::post('/admin/rejectPayment/{id}', [AdminPaymentController::class, 'reject'])->name('adminPaymentApproval.reject');
...
Route::post('/staff/rejectPayment/{id}', [StaffPaymentController::class, 'reject'])->name('staffPaymentApproval.reject');
